...
class SettingsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,NVActivityIndicatorViewable {
    ...
    func fetchData()
    {
        ...
        items.append(SettingItem(itemName: "Share and Earn", itemImage: "share.png"))
        items.append(SettingItem(itemName: "Promo Code", itemImage: "percentage.png"))
        items.append(SettingItem(itemName: "Payments", itemImage: "money.png"))
        items.append(SettingItem(itemName: "FAQ", itemImage: "profile.png"))
        items.append(SettingItem(itemName: "Your Orders", itemImage: "list.png"))
        items.append(SettingItem(itemName: "Saved Places", itemImage: "heart.png"))
        
        print(UserDefault.getType())
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "ShareAndEarnViewController") as? ShareAndEarnViewController
            self.navigationController?.pushViewController(vc!, animated: true)
        case 2:
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "PromoCodeViewController") as? PromoCodeViewController
            self.navigationController?.pushViewController(vc!, animated: true)
        case 3:
            ...
            self.navigationController?.pushViewController(vc!, animated: true)
        case 4:
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "AccordionViewController") as? AccordionViewController
            self.navigationController?.pushViewController(vc!, animated: true)
        case 5:
        ...
        case 6:
            print("sfs")
//            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "SaveLocationViewController") as? SaveLocationViewController
//            self.navigationController?.pushViewController(vc!, animated: true)
        case 7:
