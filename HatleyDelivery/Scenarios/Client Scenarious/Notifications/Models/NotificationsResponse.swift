...
//
//   let notificationsResponse = try? newJSONDecoder().decode(NotificationsResponse.self, from: jsonData)
...
struct NotificationItem: Codable {
    let id: Int?
    let type, notifiableType: String?
    let notifiableID: Int?
    let title, data, readAt: String?
